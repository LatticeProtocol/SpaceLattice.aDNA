...
## Problem
SpaceLattice.aDNA ships an `.obsidian/` config with 15 plugins (13MB, ~87% of the `.obsidian/` directory). Most are cosmetic. New operators clone 13MB of plugins they may never enable. Clone time and disk space impacted.
