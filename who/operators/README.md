...
Per-operator profiles for this Spacemacs.aDNA fork. Each operator who deploys this battle station to their machine writes a profile here capturing:
...
This is part of `who/`, alongside `upstreams/` (Spacemacs maintainers + layer authors) and `peers/` (other Spacemacs.aDNA forks).
